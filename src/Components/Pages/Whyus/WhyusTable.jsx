...
import WhyusEditDelete from "./WhyusEditDelete";
import { IoEye } from "react-icons/io5";

const WhyusTable = ({ revolutionizeData, handleEditClick, handleDeleteClick, handlePreviewClick }) => {
  return (
        ...
        <tbody>
          {revolutionizeData.map((data, index) => (
            <tr key={index} className="hover:bg-gray-50 transition">
              ...
              <WhyusEditDelete handleEditClick={handleEditClick} handleDeleteClick={handleDeleteClick} />
