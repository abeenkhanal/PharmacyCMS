...
const DiscoverPreviewModal = ({ previewPoint, closeModals }) => (
  <div id="previewModal" className="modal fixed inset-0 bg-black bg-opacity-50 items-center justify-center z-50 hidden">
...
export default DiscoverPreviewModal;
